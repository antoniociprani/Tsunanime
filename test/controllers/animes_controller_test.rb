...
class AnimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post animes_url, params: { anime: { author: @anime.author, descripton: @anime.descripton, release_date: @anime.release_date, title: @anime.title } }
    end
  ...
  test "should update anime" do
    patch anime_url(@anime), params: { anime: { author: @anime.author, descripton: @anime.descripton, release_date: @anime.release_date, title: @anime.title } }
